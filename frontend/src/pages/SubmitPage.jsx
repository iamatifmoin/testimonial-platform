...
const baseInputClasses =
  "w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 transition-colors duration-150 placeholder:text-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary-500";
const errorInputClasses = "border-red-300 bg-red-50 focus:ring-red-400";
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const isDuplicate =
        ...
        lowerMessage.includes("already have a testimonial from you");

      setSubmitError(
        isDuplicate
          ? "It looks like we already have a testimonial from you. Thank you!"
            ...
            {isSuccess ? (
              <div className="flex min-h-[420px] flex-col items-center justify-center text-center">
                ...
                <button
                  type="button"
                  onClick={resetForm}
                  className="mt-6 text-sm font-medium text-primary-600 transition-colors duration-150 hover:text-primary-700"
                >
                  Submit another
                </button>
              </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                ...
                <div>
                  <label className="block font-medium text-gray-700">Add a photo (optional)</label>
                  <input
                    ref={fileInputRef}
                    type="file"
                  ...
                  {formValues.photo && photoPreviewUrl ? (
                    <div className="mt-2 flex items-center gap-4 rounded-xl border border-gray-200 bg-gray-50 p-4">
                      ...
                      <button
                        type="button"
                        onClick={removePhoto}
                        className="text-sm font-medium text-red-500 transition-colors duration-150 hover:text-red-600"
                      >
                        Remove
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      className="mt-2 flex w-full flex-col items-center justify-center rounded-xl border border-dashed border-gray-300 bg-gray-50 px-6 py-8 text-center transition-colors duration-150 hover:border-primary-400 hover:bg-primary-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
                    >
